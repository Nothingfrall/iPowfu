...
const socialLinks = [
  { href: "https://github.com/iPowfu", icon: FaGithub, label: "GitHub" },
  { href: "https://discord.com/users/798258457022046218", icon: FaDiscord, label: "Discord" },
  { href: "https://x.com/iPowfu", icon: FaXTwitter, label: "Twitter" },
  { href: "mailto:ipowfu@proton.me", icon: Mail, label: "Email" },
];
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 py-8 min-h-[240px] flex flex-col">
        ...
        <div className="pt-6 mt-auto border-t border-border/50">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} iPowfu. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
